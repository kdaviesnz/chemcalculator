  ...
  'O(C(=O)CC1=CC2=C(C=C1)OCO2)C(=O)CC1=CC2=C(C=C1)OCO2' ]
        ...
        reagents_arr.map(
            (SMILES, i) => {
                ...
                MoleculeLookup(db, SMILES, "SMILES", true, "CarboxylicAcidToKetone reverse reagent lookup", lookup_err).then(
      ...
      //  process.exit()
        ...
        SMILES_arr.map(
            ...
            (SMILES, i) => {
                ...
                MoleculeLookup(db, SMILES, "SMILES", true, "CarboxylicAcidToKetone reverse", lookup_err).then(
                    (substrate) => {
                        callback?callback(
                            rule,
