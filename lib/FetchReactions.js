...
[ { _id: 5dc78b155f099c8738613795,
    ...
    substrate: { 'functional group': 'alcohol' },
    reagents: [ 'POCl3' ],
    products: [ 'alkene' ] },
  { _id: '5e2fd97aaf202079e0ccc2f1',
    catalyst: 'heat',
    'parent mechanism': [ 'dehydration' ],
    mechanism: 'alcohol dehydration',
    substrate: { 'functional group ': 'alcohol' },
    reagents: [ 'strong mineral acid' ],
    products: [ 'alkene' ] },
  { _id: '5e2fd999af202079e0ccc2f2',
    catalyst: 'heat',
    'parent mechanism': [ 'dehydration' ],
    mechanism: 'akyl halide dehydration',
    substrate: { 'functional group ': 'akyl halide' },
