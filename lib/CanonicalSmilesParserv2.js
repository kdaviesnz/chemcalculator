...
const WackerOxidation = require('../lib/reactions/wackerO idation.js')
...
// 'CCl' (O)
    ...
    const permanganateOxidation = (alkene_molecule, callback) => {
      ...
      //  console.log(alkene_molecule.CanonicalSMILES)
//        console.log(alkene_molecule_functional_groups)
        /*
        CC(=O)CC1=CC2=C(C=C1)OCO2
  ...
  alkene: [ [ 'CC(=O)CC1', 'CC2=C(C=C1)OCO2' ], [ [Array] ] ] }
        ...
        alkene_pairs.map(
            (alkene_pair) => {
                ...
                MoleculeLookup(db, "O" + alkene_pair[1], "SMILES", true, "permanganateOxidation",   null).then(
                    (mol) => {
                        callback(mol)
                    },
                    (err) => {
