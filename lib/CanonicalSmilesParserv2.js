    ...
    const replaceHalideWithNH2Reverse = (callback) => {
        ...
        halides.map(
            ...
            (X)=>{
                ...
                if (molecule_json_object.CanonicalSMILES.replace("N",X) === false) {
                    return false
                }
...
// CC(C(C1=CC=CC=C1))NC
    ...
    const alkeneToAmideReverse = () => {
        ...
        if (amine_parsed[1] + "=" + amine_parsed[2] === false) {
            return false
        }
    ...
    */
        if (functionalGroups.amide[1].indexOf("N")===-1?functionalGroups.amide[2]:functionalGroups.amide[1] === false) {
            return false
        }
...
// 'CC(CC1=CC2=C(C=C1)OCO2)NC'
        ...
        if (molecule_json_object.CanonicalSMILES.replace("NC","Cl") === false) {
            return false
        }
        ...
        if (molecule_json_object.CanonicalSMILES.replace("NC","Br") === false) {
            return false
        }
        ...
        if (molecule_json_object.CanonicalSMILES.replace("NC","F") === false) {
            return false
        }
        ...
        if (molecule_json_object.CanonicalSMILES.replace("NC","I") === false) {
            return false
        }
        ...
        if (molecule_json_object.CanonicalSMILES.replace("NC","[At]") === false) {
            return false
        }
